    ...
    >      {/* Enhanced Cyberpunk Background Elements */}
      <div className="absolute inset-0 opacity-30 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute w-px h-20 bg-gradient-to-b from-transparent via-cyan-400/40 to-transparent animate-data-stream-2" style={{ left: '16%' }} />
          <div className="absolute w-px h-20 bg-gradient-to-b from-transparent via-cyan-400/40 to-transparent animate-data-stream-3" style={{ left: '24%' }} />
          ...
          <div className="absolute w-px h-20 bg-gradient-to-b from-transparent via-cyan-400/40 to-transparent animate-data-stream-5" style={{ left: '40%' }} />
          <div className="absolute w-px h-20 bg-gradient-to-b from-transparent via-cyan-400/40 to-transparent animate-data-stream-6" style={{ left: '48%' }} />
          ...
          <div className="absolute w-px h-20 bg-gradient-to-b from-transparent via-cyan-400/40 to-transparent animate-data-stream-8" style={{ left: '64%' }} />
          <div className="absolute w-px h-20 bg-gradient-to-b from-transparent via-cyan-400/40 to-transparent animate-data-stream-9" style={{ left: '72%' }} />
          ...
          <div className="absolute w-px h-20 bg-gradient-to-b from-transparent via-cyan-400/40 to-transparent animate-data-stream-11" style={{ left: '88%' }} />
        ...
        </div>        {/* Floating Energy Orbs */}
        <div className="absolute inset-0">
          <div className="absolute w-2 h-2 bg-gradient-radial-cyan rounded-full animate-orb-1" style={{ left: '10%', top: '15%' }} />
          <div className="absolute w-2 h-2 bg-gradient-radial-cyan rounded-full animate-orb-2" style={{ left: '25%', top: '45%' }} />
          <div className="absolute w-2 h-2 bg-gradient-radial-cyan rounded-full animate-orb-3" style={{ left: '60%', top: '25%' }} />
          <div className="absolute w-2 h-2 bg-gradient-radial-cyan rounded-full animate-orb-4" style={{ left: '80%', top: '70%' }} />
          <div className="absolute w-2 h-2 bg-gradient-radial-cyan rounded-full animate-orb-5" style={{ left: '35%', top: '80%' }} />
          <div className="absolute w-2 h-2 bg-gradient-radial-cyan rounded-full animate-orb-6" style={{ left: '70%', top: '55%' }} />
          <div className="absolute w-2 h-2 bg-gradient-radial-cyan rounded-full animate-orb-7" style={{ left: '15%', top: '65%' }} />
          <div className="absolute w-2 h-2 bg-gradient-radial-cyan rounded-full animate-orb-8" style={{ left: '90%', top: '35%' }} />
        </div>
        ...
        <div className="absolute inset-0">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            ...
            <line x1="0" y1="40%" x2="100%" y2="40%" stroke="url(#circuit-gradient)" strokeWidth="1" />
            <line x1="0" y1="60%" x2="100%" y2="60%" stroke="url(#circuit-gradient)" strokeWidth="1" />
        ...
        </div>        {/* Matrix Rain Effect */}
        <div className="absolute inset-0">          <div className="absolute text-green-400/50 font-mono text-xs animate-matrix-1" style={{ left: '6.67%', top: '-20px' }}>01 10 11</div>
          <div className="absolute text-green-400/50 font-mono text-xs animate-matrix-2" style={{ left: '13.34%', top: '-20px' }}>10 01 00</div>
          <div className="absolute text-green-400/50 font-mono text-xs animate-matrix-3" style={{ left: '20.01%', top: '-20px' }}>11 00 01</div>
          <div className="absolute text-green-400/50 font-mono text-xs animate-matrix-4" style={{ left: '26.68%', top: '-20px' }}>00 11 10</div>
          <div className="absolute text-green-400/50 font-mono text-xs animate-matrix-5" style={{ left: '33.35%', top: '-20px' }}>01 11 00</div>
          <div className="absolute text-green-400/50 font-mono text-xs animate-matrix-6" style={{ left: '40.02%', top: '-20px' }}>10 00 11</div>
          <div className="absolute text-green-400/50 font-mono text-xs animate-matrix-7" style={{ left: '46.69%', top: '-20px' }}>11 01 10</div>
          <div className="absolute text-green-400/50 font-mono text-xs animate-matrix-8" style={{ left: '53.36%', top: '-20px' }}>00 10 01</div>
          <div className="absolute text-green-400/50 font-mono text-xs animate-matrix-9" style={{ left: '60.03%', top: '-20px' }}>01 00 11</div>
          <div className="absolute text-green-400/50 font-mono text-xs animate-matrix-10" style={{ left: '66.70%', top: '-20px' }}>10 11 00</div>
          <div className="absolute text-green-400/50 font-mono text-xs animate-matrix-11" style={{ left: '73.37%', top: '-20px' }}>11 10 01</div>
          <div className="absolute text-green-400/50 font-mono text-xs animate-matrix-12" style={{ left: '80.04%', top: '-20px' }}>00 01 11</div>
          <div className="absolute text-green-400/50 font-mono text-xs animate-matrix-13" style={{ left: '86.71%', top: '-20px' }}>01 11 10</div>
          <div className="absolute text-green-400/50 font-mono text-xs animate-matrix-14" style={{ left: '93.38%', top: '-20px' }}>10 00 01</div>
          <div className="absolute text-green-400/50 font-mono text-xs animate-matrix-15" style={{ left: '100.05%', top: '-20px' }}>11 01 00</div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mt-16 animate-slide-up delay-500">
          <div className="matte-card shiny-border rounded-2xl p-8 relative overflow-hidden cyber-glow-purple">            {/* Enhanced Background Particles and Animations */}
            <div className="absolute inset-0 opacity-70">
              {/* Floating Particles */}
              <div className="absolute inset-0">
                <div className="absolute w-2 h-2 bg-cyan-400 rounded-full animate-orb-1 shadow-lg shadow-cyan-400/50" style={{ left: '5%', top: '10%' }} />
                <div className="absolute w-2 h-2 bg-purple-400 rounded-full animate-orb-2 shadow-lg shadow-purple-400/50" style={{ left: '15%', top: '70%' }} />
                <div className="absolute w-2 h-2 bg-blue-400 rounded-full animate-orb-3 shadow-lg shadow-blue-400/50" style={{ left: '85%', top: '20%' }} />
                <div className="absolute w-2 h-2 bg-cyan-400 rounded-full animate-orb-4 shadow-lg shadow-cyan-400/50" style={{ left: '75%', top: '80%' }} />
                <div className="absolute w-1.5 h-1.5 bg-purple-400 rounded-full animate-orb-5 shadow-lg shadow-purple-400/50" style={{ left: '35%', top: '15%' }} />
                <div className="absolute w-1.5 h-1.5 bg-blue-400 rounded-full animate-orb-6 shadow-lg shadow-blue-400/50" style={{ left: '65%', top: '65%' }} />
                <div className="absolute w-1 h-1 bg-cyan-400 rounded-full animate-orb-7 shadow-md shadow-cyan-400/50" style={{ left: '25%', top: '40%' }} />
                <div className="absolute w-1 h-1 bg-purple-400 rounded-full animate-orb-8 shadow-md shadow-purple-400/50" style={{ left: '90%', top: '50%' }} />
              </div>

              {/* Data Stream Particles */}
              <div className="absolute inset-0">
                <div className="absolute w-0.5 h-12 bg-gradient-to-b from-transparent via-cyan-400 to-transparent animate-data-stream-1 shadow-sm shadow-cyan-400/50" style={{ left: '20%' }} />
                <div className="absolute w-0.5 h-12 bg-gradient-to-b from-transparent via-purple-400 to-transparent animate-data-stream-3 shadow-sm shadow-purple-400/50" style={{ left: '50%' }} />
                <div className="absolute w-0.5 h-12 bg-gradient-to-b from-transparent via-blue-400 to-transparent animate-data-stream-5 shadow-sm shadow-blue-400/50" style={{ left: '80%' }} />
              </div>              {/* Circuit Traces */}
              <div className="absolute inset-0">
                <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <linearGradient id="cta-circuit" x1="0%" y1="0%" x2="100%" y2="0%">
                      <stop offset="0%" stopColor="transparent" />
                    ...
                    <linearGradient id="cta-circuit-2" x1="0%" y1="0%" x2="100%" y2="0%">
                      <stop offset="0%" stopColor="transparent" />
                  ...
                  <line x1="0" y1="25%" x2="100%" y2="25%" stroke="url(#cta-circuit)" strokeWidth="2" />
                  <line x1="0" y1="75%" x2="100%" y2="75%" stroke="url(#cta-circuit-2)" strokeWidth="2" />
              ...
              <div className="absolute inset-0">
                <div className="absolute top-0 left-0 w-full h-full">
                  <div className="absolute w-20 h-20 border-2 border-cyan-400/60 rounded-full animate-cyber-pulse shadow-lg shadow-cyan-400/30" style={{ left: '10%', top: '20%' }} />
                  <div className="absolute w-16 h-16 border-2 border-purple-400/60 rounded-full animate-cyber-pulse shadow-lg shadow-purple-400/30" style={{ left: '80%', top: '60%', animationDelay: '1s' }} />
                  <div className="absolute w-12 h-12 border-2 border-blue-400/60 rounded-full animate-cyber-pulse shadow-lg shadow-blue-400/30" style={{ left: '60%', top: '30%', animationDelay: '2s' }} />
                </div>
              </div>

              {/* Matrix-style Binary Code */}
              <div className="absolute inset-0 font-mono text-sm">
                <div className="absolute text-green-400/80 animate-matrix-1 font-bold" style={{ left: '5%', top: '5%' }}>01</div>
                <div className="absolute text-green-400/80 animate-matrix-3 font-bold" style={{ left: '92%', top: '8%' }}>11</div>
                <div className="absolute text-green-400/80 animate-matrix-5 font-bold" style={{ left: '8%', top: '85%' }}>10</div>
                <div className="absolute text-green-400/80 animate-matrix-7 font-bold" style={{ left: '88%', top: '88%' }}>00</div>
              </div>              {/* Neural Network Pattern */}
                ...
                <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <pattern
                      ...
                      patternUnits="userSpaceOnUse"
                    >
                      <circle cx="20" cy="20" r="1" fill="#3b82f6" opacity="0.8">
                        <animate
                          attributeName="opacity"
                          values="0.4;1;0.4"
                          dur="3s"
                      ...
                      <line x1="0" y1="20" x2="40" y2="20" stroke="#8b5cf6" strokeWidth="0.5" opacity="0.6">
                        <animate
                          attributeName="opacity"
                          values="0.3;0.8;0.3"
                          dur="5s"
                      ...
                      <line x1="20" y1="0" x2="20" y2="40" stroke="#06b6d4" strokeWidth="0.5" opacity="0.6">
                        <animate
                          attributeName="opacity"
                          values="0.3;0.8;0.3"
                          dur="6s"
